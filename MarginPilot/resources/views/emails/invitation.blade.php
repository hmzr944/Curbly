...
<body>
    <div class="wrapper">
        <div class="header">
            ...
            <div class="header-title">You've been invited to<br>{{ $organizationName }}</div>
        </div>
        <div class="body">
            <p class="text">
                <strong>{{ $inviterName }}</strong> has invited you to join <strong>{{ $organizationName }}</strong> on Margexa — the AI margin control platform.
            </p>
            <div class="role-badge">{{ $role }}</div>
            <p class="text">
                Click below to accept your invitation and set up your account. The link expires on {{ $expiresAt ?? '7 days from now' }}.
            </p>
            ...
            <p class="footer-text">
                ...
                This email was sent from Margexa &mdash; <a href="{{ url('/') }}">margexa.io</a>
            </p>
        </div>
    </div>
</body>
